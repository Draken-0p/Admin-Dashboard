...
function useDrivePicker() {
    ...
    var _a = (0, useInjectScript_1.useInjectScript)(), loaded = _a[0], error = _a[1];
    var _b = (0, react_1.useState)(false), pickerApiLoaded = _b[0], setpickerApiLoaded = _b[1];
    var _c = (0, react_1.useState)(false), openAfterAuth = _c[0], setOpenAfterAuth = _c[1];
    var _d = (0, react_1.useState)(false), authWindowVisible = _d[0], setAuthWindowVisible = _d[1];
